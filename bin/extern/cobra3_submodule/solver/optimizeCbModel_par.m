function FBAsolution = optimizeCbModel_par(model,thesolver,osenseStr, minNorm, allowLoops)
...
% Solve initial LP
if allowLoops
    solution = solveCobraLP_par(LPproblem,thesolver);
else
...
if strcmp(minNorm, 'one')
    ...
    if allowLoops
        solution = solveCobraLP_par(LPproblem2,thesolver); %,printLevel,minNorm);
