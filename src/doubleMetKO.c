...
{ 
	...
	printf("FastKO:doubleGeneDeletion: Number of objective function is %d\n",num_obj);
	...
	printf("FastKO: Start single metabolite deletion....\n");
	...
	printf("FastKO:doubleMetKO:  Single metabolite deletion: completed!\n\n");

	printf("FastKO:doubleMetKO:  Start Double metabolite deletion\n");
