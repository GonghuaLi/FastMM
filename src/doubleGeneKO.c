...
{ 
	...
	printf("FastKO:doubleGeneKO: Number of objective function is %d\n",num_obj);
    ...
    printf("FastKO:doubleGeneKO: Number of active genes is %d\n",num_effective_genes);
	...
	printf("FastKO:doubleGeneKO:  Start single gene deletion....\n");
	...
	printf("FastKO:doubleGeneKO:  Single gene deletion: completed!\n\n");

	printf("FastKO:doubleGeneKO:  Start Double gene deletion\n");
